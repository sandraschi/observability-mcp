            ...
            <CardContent>
              <div className="font-mono text-sm text-slate-400 space-y-2">
                <p>
                  ...
                  Unitree H1 connected to control server
                </p>
                <p>
                  [10:41:22] <span className="text-yellow-500">WARN</span> Go2
                  Alpha latency spike (145ms)
                </p>
                <p>
                  [10:40:05] <span className="text-blue-500">DEBUG</span> Mqtt
                  connection established on wss://robotics.local
                </p>
              </div>
            </CardContent>
          </Card>
